...
@section('breadcrumb')
    {{ Breadcrumbs::render('admin.regime.edit') }}
@stop
        ...
        <div class="col-md-5">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.regime.update',['id' => $regimeTrab->id]) }}" id="formSend" class="form-validate-jquery" method="POST" autocomplete="off">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <fieldset>
