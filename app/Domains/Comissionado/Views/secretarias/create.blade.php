...
@section('breadcrumb')
    {{ Breadcrumbs::render('admin.secretarias.create') }}
@stop
        ...
        <div class="col-md-5">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.secretarias.store') }}" id="formSend" class="form-validate-jquery" method="POST" autocomplete="off">
                        {{ csrf_field() }}
                        <fieldset>
