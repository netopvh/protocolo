...
@section('breadcrumb')
    {{ Breadcrumbs::render('admin.cargos') }}
@stop
        ...
        <div class="col-md-6">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    ...
                    <a href="{{ route('admin.cargos.create') }}" class="btn btn-primary btn-raised legitRipple"><i
                                        ...
                                        <ul class="icons-list">
                                            ...
                                            <li>
                                                <form class="form-delete"
                                                      action="{{ route('admin.cargos.destroy',['id'=>$cargo->id]) }}"
                                                      method="POST">
