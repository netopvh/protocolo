    ...
    @section('breadcrumb')
        {{ Breadcrumbs::render('admin.comissionados') }}
    @stop
            ...
            <div class="col-md-6">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        ...
                        <a href="{{ route('admin.comissionados.create') }}"
                    ...
                    <tbody>
                    @if(count($cargoComissionado))
                        @foreach($cargoComissionado as $cargos)
                            <tr>
                                <td>{{ $cargos->id }}</td>
                                ...
                                <td>
                                    <ul class="icons-list">
                                        ...
                                        <li><a href="{{ route('admin.comissionados.show',['id' => $cargos->id]) }}"
                                               data-popup="tooltip" title="Visualizar" data-placement="bottom"><i
                                                        class="icon-eye"></i></a>
                                        </li>
                                        @endpermission
                                        @permission('atualizar-cargos-comissionados')
                                        <li><a href="{{ route('admin.comissionados.edit',['id' => $cargos->id]) }}"
                                        ...
                                        <li>
                                            <form class="form-delete"
                                                  action="{{ route('admin.comissionados.destroy',['id'=>$cargos->id]) }}"
                                                  method="POST">
