...
@section('breadcrumb')
    {{ Breadcrumbs::render('admin.comissionados.edit') }}
@stop
        ...
        <div class="col-md-5">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.comissionados.update',['id' => $cargoComissionado->id]) }}" id="formSend" class="form-validate-jquery" method="POST" autocomplete="off">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <fieldset>
                        ...
                        <div class="text-right">
                            <a href="{{ route('admin.comissionados') }}" class="btn btn-info legitRipple"><i class="icon-database-arrow"></i> Retornar</a>
