...
@section('breadcrumb')
    {{ Breadcrumbs::render('admin.nomenclatura.edit') }}
@stop
        ...
        <div class="col-md-5">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.nomenclatura.update',['id' => $nomenclaturaCargo->id]) }}" id="formSend" class="form-validate-jquery" method="POST" autocomplete="off">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="descricao" value="{{ $nomenclaturaCargo->descricao }}" type="text" class="form-control text-uppercase" required autofocus>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
