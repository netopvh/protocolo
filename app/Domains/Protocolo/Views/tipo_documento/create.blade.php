...
@section('breadcrumb')
    {{ Breadcrumbs::render('admin.tipo_documento.create') }}
@stop
        ...
        <div class="col-md-5">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.tipo_documento.store') }}" id="formSend" class="form-validate-jquery" method="POST" autocomplete="off">
                        {{ csrf_field() }}
                        <fieldset>
