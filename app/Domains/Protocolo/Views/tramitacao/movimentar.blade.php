        ...
        <div class="col-md-9">
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="{{ route('admin.tramitacao.movimentar.store') }}" id="form_documento"
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="text-bold">Setor/Departamento de Destino:</label>
                                        <select name="id_destino" class="select-search">
                                            <option></option>
                        ...
                        <div class="text-right">
                            ...
                            <button type="submit" id="btn_tramitacao" class="btn btn-primary legitRipple">Encaminhar
                                Documento <i
