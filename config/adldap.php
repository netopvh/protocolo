            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'account_suffix' => env('ADLDAP_ACCOUNT_SUFFIX', '@portovelho.ro.gov.br'),
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', '10.103.1.4')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=PORTOVELHO,dc=RO,dc=GOV,dc=BR'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'sistemascgm'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', '@cgmSIS2017'),
